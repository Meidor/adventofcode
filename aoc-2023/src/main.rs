...
fn day16_part01() -> Result<()>{
    let input = include_str!("../inputs/day16.txt");
    let start = Instant::now();
    println!("part one:");
    println!("{}", day16::part_one(input)?);
    println!();
    let elapsed = start.elapsed();
    println!("took {}ms ({}us)  ", elapsed.as_millis(), elapsed.as_micros());
    println!();
...
fn day16_part02() -> Result<()>{
    let input = include_str!("../inputs/day16.txt");
    let start = Instant::now();
    println!("part two:");
    println!("{}", day16::part_two(input)?);
    println!();
    let elapsed = start.elapsed();
    println!("took {}ms ({}us)  ", elapsed.as_millis(), elapsed.as_micros());
    println!();
...
fn day17_part01() -> Result<()>{
    let input = include_str!("../inputs/day17.txt");
    let start = Instant::now();
    println!("part one:");
    println!("{}", day17::part_one(input)?);
    println!();
    let elapsed = start.elapsed();
    println!("took {}ms ({}us)  ", elapsed.as_millis(), elapsed.as_micros());
    println!();
...
fn day17_part02() -> Result<()>{
    let input = include_str!("../inputs/day17.txt");
    let start = Instant::now();
    println!("part two:");
    println!("{}", day17::part_two(input)?);
    println!();
    let elapsed = start.elapsed();
    println!("took {}ms ({}us)  ", elapsed.as_millis(), elapsed.as_micros());
    println!();
...
fn day19_part01() -> Result<()>{
    let input = include_str!("../inputs/day19.txt");
    let start = Instant::now();
    println!("part one:");
    println!("{}", day19::part_one(input)?);
    println!();
    let elapsed = start.elapsed();
    println!("took {}ms ({}us)  ", elapsed.as_millis(), elapsed.as_micros());
    println!();
...
fn day19_part02() -> Result<()>{
    let input = include_str!("../inputs/day19.txt");
    let start = Instant::now();
    println!("part two:");
    println!("{}", day19::part_two(input)?);
    println!();
    let elapsed = start.elapsed();
    println!("took {}ms ({}us)  ", elapsed.as_millis(), elapsed.as_micros());
    println!();
...
fn get_days() -> Result<Days> {
    ...
    days.insert("day16_part01".to_string(), day16_part01);
    days.insert("day16_part02".to_string(), day16_part02);
    ...
    days.insert("day19_part01".to_string(), day19_part01);
    days.insert("day19_part02".to_string(), day19_part02);
